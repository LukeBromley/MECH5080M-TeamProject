...
save_plan_file_name = "../testing_plans/ML_EvenSpawning_AllAI_StableNet.plan"
...
for index, junction in enumerate(junctions):
    ...
    for random_seed_value in random_seed_values:
        ...
        for spawn_time_delta_value in spawn_time_delta_values:
            ...
            plan[str(uid)] = {
                "RunUID": "ML_EvenSpawning_AllAI_StableNet_" + str(junction) + "_" + str(random_seed_value) + "_" + str(round(60 / spawn_time_delta_value, 2)) + "cpm",
                "RunType": "junction",
                "Junction": junction,
...
save_plan_file_name = "../testing_plans/ML_EvenSpawning_MixedDriver_StableNet.plan"
...
for autonomous_percentage_value in autonomous_percentage_values:
    ...
    for random_seed_value in random_seed_values:
        ...
        for spawn_time_delta_value in spawn_time_delta_values:
            ...
            plan[str(uid)] = {
                "RunUID": "ML_EvenSpawning_MixedDriver_StableNet_" + str(autonomous_percentage_value) + "_" + str(random_seed_value) + "_" + str(round(60/spawn_time_delta_value, 2)) + "cpm" ,
                "RunType": "junction",
...
save_plan_file_name = "../testing_plans/ML_EvenSpawning_AllAI_LatencyNet.plan"
...
for latency in network_latency:
    ...
    for random_seed_value in random_seed_values:
        ...
        for spawn_time_delta_value in spawn_time_delta_values:
            ...
            plan[str(uid)] = {
                "RunUID": "ML_EvenSpawning_AllAI_LatencyNet_" + str(latency) + "_" + str(random_seed_value) + "_" + str(round(60 / spawn_time_delta_value, 2)) + "cpm",
                "RunType": "junction",
                "Junction": junctions[0],
                "SimulationConfig": "final_testing/even_spawning/autonomous/seed_" + str(random_seed_value) + "/" + str(round(60 / spawn_time_delta_value, 2)) + "cpm.config",
                "MachineLearningModel": ml_model[0],
...
save_plan_file_name = "../testing_plans/ML_EvenSpawning_AllAI_PacketLossNet.plan"
...
for packet_loss in packet_loss_perc:
    ...
    for random_seed_value in random_seed_values:
        ...
        for spawn_time_delta_value in spawn_time_delta_values:
            ...
            plan[str(uid)] = {
                "RunUID": "ML_EvenSpawning_AllAI_PacketLossNet_" + str(packet_loss) + "_" + str(random_seed_value) + "_" + str(round(60 / spawn_time_delta_value, 2)) + "cpm",
                "RunType": "junction",
                "Junction": junctions[0],
                "SimulationConfig": "final_testing/even_spawning/autonomous/seed_" + str(random_seed_value) + "/" + str(round(60 / spawn_time_delta_value, 2)) + "cpm.config",
                "MachineLearningModel": ml_model[0],
