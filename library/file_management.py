...
class FileManagement:
    def __init__(self) -> None:
        ...
        self.autonomous_preferred_time_gap_key = "autonomous_preferred_time_gap"
        self.human_preferred_time_gap_key = "human_preferred_time_gap"
        ...
        self.autonomous_driver_probability_key = "autonomous_driver_probability"
        # Visualiser
    ...
    def load_sim_config_file(self, file_path: str) -> SimulationConfiguration:
        ...
        s_config.autonomous_preferred_time_gap = file_dict[self.autonomous_preferred_time_gap_key]
        s_config.human_preferred_time_gap = file_dict[self.human_preferred_time_gap_key]
        ...
        s_config.autonomous_driver_probability = file_dict[self.autonomous_driver_probability_key]
