...
class Button(QtWidgets.QPushButton):
    def __init__(self, parent_widget, text, layout=None, width=None, height=None, fontsize=9, bold=False):
        super().__init__(parent_widget)
        self.setText(text)
        if layout is not None:
            layout.addWidget(self)
        ...
        # if bold:
        #     button.setFont(QtGui.QFont(self.Font, fontsize, QtGui.QFont.Bold))
        # else:
        #     button.setFont(QtGui.QFont(self.Font, fontsize))
