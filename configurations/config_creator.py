...
save_config_folder_path = "simulation_config/final_testing/uneven_spawning_simple_T/"
...
random_seed_values = [1788621521, 1774553582, 1490597230, 997415346, 1433874439]
autonomous_percentage_values = [1.0]
uneven_spawning = True
spawn_time_delta_values = { "side_low_(10-30-30)": [10,30,30],
                            "" : [10,50,50],
                            "" : [30,10,10],
                            "" : [30,50,50],
                            "" : [50,30,30],
...
for autonomous_percentage_value in autonomous_percentage_values:
    ...
    for random_seed_value in random_seed_values:
        ...
        for spawn_time_delta_value in spawn_time_delta_values:
            ...
            if uneven_spawning:
                timings = dict()
                for i, delta in enumerate(spawn_time_delta_value):
                    timings[str(spawning_nodes[i])] = delta
            else:
                timings = spawn_time_delta_value
            print(timings)
            new_config.mean_spawn_time_per_hour = timings
